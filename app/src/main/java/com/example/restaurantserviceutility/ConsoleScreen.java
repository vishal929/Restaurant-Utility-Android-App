...
import com.example.restaurantserviceutility.Networking.MyWifiReceiver;
...
public class ConsoleScreen extends AppCompatActivity implements MyTextInputDialog.ReturnText {
    ...
    //internet functionality (we need to show up on the network as a console for kitchens, waiters to connect to)
